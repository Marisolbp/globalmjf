...
switch($_GET["op"]){
    ...
    case "registrar_foto":
        if (isset($_FILES) && count($_FILES) > 0) {
            ...
            $ultimo_orden = $propiedad->obtener_ultimo_orden($_POST['id_propiedad']);  // Este método lo creas en tu modelo
            ...
            for ($i = 0; $i < $total_archivos; $i++) {
                ...
                $resultado = $propiedad->registrar_foto($_POST['id_propiedad'], $foto_contenido, $foto_nombre, $orden);
