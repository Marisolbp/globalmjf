...
<div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">Miembros</h5>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    <li class="breadcrumb-item"><a href="../Home/"><i class="bx bx-home-alt"></i></a>
                                    </li>
                                    <li class="breadcrumb-item active">Miembros
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                <div class="row">
                    <div class="col-12">
                        <button type="button" type="button" onclick="return nuevoMiembro()" class="btn mr-1 mb-1 btn-primary">Nuevo</button>
                    </div>
                </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body card-dashboard">
                                        <div class="table-responsive">
                                            <table id="data_miembro" class="stripe row-border order-column">
                                                <thead>
                                                    <tr>
                                                        <th>Nombres</th>
                                                        <th>Apellidos</th>
