<div class="modal fade text-left" id="modal_foto_proyecto" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title white" id="lblTitle">Fotos de proyecto de arquitectura</h5>
            </div>
            <div class="modal-body">
                <div class="card-content">
                    <form method="post" id="proyecto_foto_form">
                    ...
                    <div class="table-responsive">
                        <table id="data_foto_proyecto" class="stripe row-border order-column">
                            <thead>
                                <tr>
                                    <th>Nombre</th>
                                    <th>Foto</th>
